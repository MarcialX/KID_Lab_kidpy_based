...
#clkFreq = int(gc[np.where(gc == 'clkFreq')[0][0]][1])
#clkPow = int(gc[np.where(gc == 'clkPow')[0][0]][1])
#LOFreq = int(gc[np.where(gc == 'LOFreq')[0][0]][1])
#LOPow = int(gc[np.where(gc == 'LOPow')[0][0]][1])
#synthDefaultParam = [clkFreq, clkPow, LOFreq, LOPow]
