...
class Synthesizer(object):
    ...
    # -- Source(s) functions --
    def setControlChannel(self):
        if self.sd['NAME'] == 'Windfreak SyntHD' : return self.synth.getControlChannel()

    def setControlChannel(self,value): 
        if self.sd['NAME'] == 'Windfreak SyntHD' : return self.synth.setControlChannel(value) # value in [0,1]
    ...
    def setFrequency(self, freq):
        ...
        elif self.sd['NAME'] == 'Windfreak SyntHD' : self.synth.setFrequencyFast(freq)
    ...
    # -- Windfreak SynthHD specific functions --
    def setRFMute(self, value):
        if self.sd['NAME'] == 'Windfreak SyntHD' : return self.synth.setRFMute(value) # value in [0,1]
        
    def setRFAmp(self, value):
        if self.sd['NAME'] == 'Windfreak SyntHD' : return self.synth.setRFAmp(value) # value in [0,1]
